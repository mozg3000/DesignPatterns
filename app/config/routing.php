...
use Controller\PageControllers\OrderPages\OrderCheckout;
use Controller\PageControllers\OrderPages\OrderInfo;
...
$routes->add(
    'order_info',
    new Route('/order/info', ['_controller' => [OrderInfo::class, 'infoAction']])
);
$routes->add(
    'order_checkout',
    new Route('/order/checkout', ['_controller' => [OrderCheckout::class, 'checkoutAction']])
);
